...
* Clone or fork the repository: `git clone https://github.com/ur-tcs/programming-2-ex-1.git` or download it by clicking on the green `<code>` button and select `download`.
