...
* Clone, fork or download the following repository: `git clone git@github.com:jcailler/programming-2-ex-1.git` or [https://github.com/jcailler/programming-2-ex-1](https://github.com/ur-tcs/programming-2-ex-1.git)
